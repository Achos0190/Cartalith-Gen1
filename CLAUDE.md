...
| File | Lines | Role |
|------|-------|------|
| `elevation_foundation_v0.054.html` | ~3,400 | **Current** procedural heightmap/terrain/climate generator |
| `elevation_foundation_v0.036–53.html` | — | Previous versions (kept; don't edit) |
