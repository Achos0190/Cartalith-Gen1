...
| File | Lines | Role |
|------|-------|------|
| `elevation_foundation_v0.049.html` | ~3,000 | **Current** procedural heightmap/terrain/climate generator |
| `elevation_foundation_v0.036–48.html` | — | Previous versions (kept; don't edit) |
