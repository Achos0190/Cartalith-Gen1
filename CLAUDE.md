...
| File | Lines | Role |
|------|-------|------|
| `elevation_foundation_v0.053.html` | ~3,300 | **Current** procedural heightmap/terrain/climate generator |
| `elevation_foundation_v0.036–52.html` | — | Previous versions (kept; don't edit) |
