...
| File | Lines | Role |
|------|-------|------|
| `elevation_foundation_v0.040.html` | ~2,500 | **Current** procedural heightmap/terrain/climate generator |
| `elevation_foundation_v0.036–39.html` | — | Previous versions (kept; don't edit) |
