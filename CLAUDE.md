...
| File | Lines | Role |
|------|-------|------|
| `elevation_foundation_v0.048.html` | ~2,900 | **Current** procedural heightmap/terrain/climate generator |
| `elevation_foundation_v0.036–47.html` | — | Previous versions (kept; don't edit) |
