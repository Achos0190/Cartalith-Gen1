...
| File | Lines | Role |
|------|-------|------|
| `elevation_foundation_v0.050.html` | ~3,100 | **Current** procedural heightmap/terrain/climate generator |
| `elevation_foundation_v0.036–49.html` | — | Previous versions (kept; don't edit) |
