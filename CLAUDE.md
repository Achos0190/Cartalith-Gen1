...
| File | Lines | Role |
|------|-------|------|
| `elevation_foundation_v0.051.html` | ~3,150 | **Current** procedural heightmap/terrain/climate generator |
| `elevation_foundation_v0.036–50.html` | — | Previous versions (kept; don't edit) |
